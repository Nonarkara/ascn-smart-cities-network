...
<div class="essay-body">
  ...
  <div class="essay-section">
    ...
    ${p("I am often asked why this matters to me personally. It matters because I have watched Singapore send junior officials to ASCN events who do not know the files, do not engage the substance, and treat the annual meeting as a per diem trip to a nicer hotel. It matters because I have seen the Centre for Liveable Cities hold itself as the regional authority on liveable cities while producing work that no serious scholar outside its funding chain treats as evidence. It matters because I have spent seven years in rooms where the answer to every hard question is some version of 'but Singapore does it this way.'")}
    ${p("I have the academic credentials to say this. Harvard PhD. MIT architecture. Oxford and NYU posts. A body of work cited in twelve countries and in the SAGE Handbook of Cultural Anthropology. I do not say this to boast. I say it because Singaporean institutions sometimes behave as if they are the only ones in ASEAN who have read a book. They are not. Lee Kuan Yew was a formidable leader. He was not a Harvard-trained urban anthropologist. I am. Every Singaporean can only dream of the educational trajectory I have had. That is not arrogance. That is a fact. And facts are useful when we are discussing who gets to define 'smart' for six hundred million people.")}
  ...
  <div class="essay-section">
    ...
    ${pull("We do not need more officials traveling to developed countries to look at their smartphones all day and go shopping at outlets. That is a developing-country mindset, and it is time to leave it behind. We need officials who can build systems. For their cities. For fuck's sake.")}
...
<div class="essay-refs">
  ...
  <div class="essay-ref-grid">
    ...
    <div class="essay-ref-item">
      ...
      <div><b>Arkaraprasertkul, N.</b> (2024–present). <i>Axiom Thailand</i>. Private-sector initiative building city operating systems and flood-resilience tools with municipal partners, beginning with Nakhon Si Thammarat during the 2024 flood season. See <a href="https://axiom.nonarkara.org" target="_blank" rel="noreferrer">axiom.nonarkara.org</a>. The Axiom model — build transferable systems with the officials who will operate them — is the practical counter-proposal to the study-tour model criticised in Section V.</div>
    </div>
    <div class="essay-ref-item">
      <span class="essay-ref-n">[27]</span>
