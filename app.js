...
<div class="essay-body">
  ...
  <div class="essay-section">
    ...
    ${p("The four M&amp;E cycles add a different kind of evidence to these critiques. The network grew from 77 projects in 2022 to 134 in 2025 — a 74% expansion — but the growth was not evenly distributed. Malaysia and Thailand drove the 2024–2025 surge, adding nineteen projects between them. Vietnam's documented portfolio stayed flat at six projects every cycle. Myanmar's grew steadily from eleven to fourteen projects despite the 2021 crisis. Health &amp; Well-Being remained at 6% of the portfolio for four consecutive years, including the pandemic years. These patterns do not prove the critiques right or wrong, but they show that the network's political economy — who chairs, who shepherds, who can report, who cannot — is visible in the project data.<sup>[25]</sup>")}
  ...
  <div class="essay-section">
    ...
    ${p("There is no single regional opinion of ASCN. There are national readings, shaped by capacity, political system, and proximity to the network's centre of gravity. Indonesia, holding the Shepherd role through 2027, reads the network as a platform for regional leadership: the phrase 'from architecture to engine' appears in both policy commentary and scholarship, and the ASEAN Smart City Investment Toolkit is treated as a diplomatic legacy. Singapore is read — including by its own scholars — as the architect whose institutional assumptions became the regional default. Thailand reads ASCN through its own national smart-city programme, which is larger than its ASCN portfolio and more outcome-oriented. Vietnam participates quietly: its three ASCN cities report consistently, but Vietnamese scholarship and media produce little public commentary on the network itself.")}
    ${p("The smaller and less-resourced members read ASCN differently again. Cambodia and Lao PDR emphasize external-partner support and capacity gaps; their ASCN participation is inseparable from JICA, ADB, and bilateral assistance. Myanmar's participation continues technically, but civil-society voices oppose engagement with the junta, and the country's smart-city plans have been overtaken by crisis. Brunei has the smallest footprint and treats ASCN as an extension of its Wawasan 2035 digital-government goals. Timor-Leste's Dili joined in January 2026 — a symbolic expansion that forces the question of what 'smart city' means in a country where internet costs are sixteen times higher than Cambodia's and poverty remains above 40%.")}
    ...
    ${p("These divergent readings are not a design flaw. They are the predictable result of a voluntary, non-binding framework applied across a region with a six-hundred-fold income gap between its richest and poorest member states. The ASEAN Way makes this possible: no city can be expelled, no standard can be enforced, no member can be compelled to report. What the framework cannot do is ensure that the network's benefits are distributed evenly, or that the critiques from Phnom Penh and Yangon reach the annual meeting in the same form as the reports from Singapore and Kuala Lumpur. The data on this platform makes those asymmetries visible. That is a beginning, not a conclusion.")}
  </div>
